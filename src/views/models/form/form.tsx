      ...
      >
        {({
          ...
          <form noValidate onSubmit={handleSubmit}>
            <div
              className={`container-form-services ${
                isUpdate && "container-form-services-full-grid"
              }`}
            >
              <MainCard
                className={"form-data"}
              ...
              >
                ...
                <FormControl className="field-form" fullWidth>
                  <TextField
                    ...
                    helperText={
                      touched.refrigerantType ? errors.refrigerantType : ""
                    }
                ...
                <FormControl className="field-form" fullWidth>
                  <TextField
                    ...
                    helperText={
                      touched.engineOilType ? errors.engineOilType : ""
                    }
                ...
                <FormControl className="field-form" fullWidth>
                  <TextField
                    ...
                    helperText={
                      touched.seatsQuantity ? errors.seatsQuantity : ""
                    }
              ...
              {isCreated && (
                <div className={"form-data activites-crud"}>
                  <RecommendedServicesCreateField
                    ...
                    helperText={
                      touched.services
                        ? getErrorOnArrayOrText(errors.services)
                        : ""
                    }
  ...
  return useMemo(() => {
    ...
    if (isCreated) {
      extraValidationSchema = {
        modelId: Yup.string()
          ...
          .max(
            64,
            "El código del modelo del vehículo debe tener menos de 64 caracteres"
          ),
        services: Yup.array(),
      };
    }
    ...
    return Yup.object().shape({
      ...
      description: Yup.string()
        .required(
          "Es necesario agregar una descripción del modelo del vehículo"
        )
      ...
      seatsQuantity: Yup.number().min(
        1,
        "La cantidad de asientos debe ser mayor o igual a 1"
      ),
      refrigerantType: Yup.string()
        .required("Es necesario indicar un tipo de refrigerante")
        .max(
          32,
          "El nombre del refrigerante debe tener menos de 32 caracteres"
        ),
      engineOilType: Yup.string()
        .required(
          "Es necesario indicar el tipo de aceite del modelo del vehículo"
        )
        .max(
          32,
          "El tipo de aceite del modelo del vehículo debe tener menos de 32 caracteres"
        ),
      oilBox: Yup.string()
        .required("Es necesario indicar un modelo de caja de aceite")
        .max(
          32,
          "El modelo de caja de aceite debe tener menos de 32 caracteres"
        ),
